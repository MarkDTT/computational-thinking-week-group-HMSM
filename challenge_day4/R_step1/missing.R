...
json_data <- fromJSON("/Users/qbit/Documents/computational-thinking-week-group-HMSM/challenge_day4/fulldata/data1.json")
...
write(json_text, "/Users/qbit/Documents/computational-thinking-week-group-HMSM/challenge_day4/fulldata/data2.json")
